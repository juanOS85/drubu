...
function YoursWaypointCreateDOM(yourLs, waypoint) {
	...
	var del_button = $(document.createElement("input"));
        ...
        jQuery(del_button).attr("src", "images/del.png");
	...
	var via_image = $(document.createElement("img"));
        jQuery(via_image).attr("src", "images/ajax-loader.gif");
...
// We could make this a method acting on a Yours Route object.
	switch (code) {
		...
		case Yours.status.starting:
			...
			jQuery(yourLs.status).html('Calculating route <img src="images/ajax-loader.gif">');
			break;
